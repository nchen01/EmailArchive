...
| S17 | Audited handoff package MVP — employee-initiated scope review, package publish, one-time recipient link, read-only recipient view, deterministic package-local ask, revoke, new-version re-share/supersede, static HTML export, audit lifecycle | ✓ done (S17.2–S17.11); e2e-validated | `docs/s17-handoff-package-mvp-plan.md`, `docs/s17-live-validation.md` |
