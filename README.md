...
(safe metadata only). Security reviewers get masked recipient email and no provider
email/scopes; aggregate exclusion counts only; no admin mutations yet (revoke/
